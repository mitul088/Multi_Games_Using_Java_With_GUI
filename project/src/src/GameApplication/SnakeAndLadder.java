package src.GameApplication;
/* This is the class which Main other classes*/


import project.Game1Play;
...
public class SnakeAndLadder extends JFrame {
	...
	final static Color snakehead = Color.CYAN, snaketail = Color.CYAN,
	...
	public SnakeAndLadder() {
		...
		contentPane.setBackground(new Color(241, 218, 218));

		settingsFrame = new SettingsFrame(this);
		generator = new Random();

		JMenuBar menuBar = new JMenuBar();
		menuBar.setBackground(new Color(241, 218, 218));
//		menuBar.setCursor(new Cursor(Cursor.HAND_CURSOR));
		setJMenuBar(menuBar);

		JMenu mnNewMenu = new JMenu("Menu");
		mnNewMenu.setBackground(new Color(241, 218, 218));
		mnNewMenu.setCursor(new Cursor(Cursor.HAND_CURSOR));
		menuBar.add(mnNewMenu);

		JMenuItem mntmNewGame = new JMenuItem("New Game");
		mntmNewGame.setBackground(new Color(241, 218, 218));
		mntmNewGame.setCursor(new Cursor(Cursor.HAND_CURSOR));
		...
		JMenuItem mntmExitGame = new JMenuItem("Home Page");
		mntmExitGame.setBackground(new Color(241, 218, 218));
		mntmExitGame.setCursor(new Cursor(Cursor.HAND_CURSOR));
		...
		mnNewMenu.add(mntmExitGame);

		JMenuItem mntmSettings = new JMenuItem("Settings");
		mntmSettings.setBackground(new Color(241, 218, 218));
		mntmSettings.setCursor(new Cursor(Cursor.HAND_CURSOR));
		...
		mnNewMenu_1.setBackground(new Color(241, 218, 218));
		mnNewMenu_1.setCursor(new Cursor(Cursor.HAND_CURSOR));
		menuBar.add(mnNewMenu_1);

		JMenuItem mntmInstructions = new JMenuItem("Instructions");
		mntmInstructions.setBackground(new Color(241, 218, 218));
		mntmInstructions.setCursor(new Cursor(Cursor.HAND_CURSOR));
		...
		mnAboutMe.setCursor(new Cursor(Cursor.HAND_CURSOR));
		menuBar.add(mnAboutMe);
		
		mntmNewMenuItem = new JMenuItem("About Me");
		mntmNewMenuItem.setBackground(new Color(241, 218, 218));
		...
		if (currentPlayer == 1) {
			...
			for (int i = 0; i < Nladders; ++i) {
				if (ladders[i][0] == newposition) {
					lblMessage.setText("You are up through ladder at position "
							+ newposition + " !");
//					JOptionPane.showMessageDialog(("You are up through ladder at position "
//							+ newposition + " !");
					newposition = ladders[i][1];
					if (newposition == total) {// Ladder directly to win.
						JOptionPane.showMessageDialog(null, "Congratulations "
