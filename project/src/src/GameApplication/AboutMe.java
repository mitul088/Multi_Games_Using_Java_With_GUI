...
public class AboutMe extends JDialog {
	...
	public AboutMe() {
		...
		contentPanel.setBackground(new Color(147, 67, 67));
		JLabel lblNewLabel = new JLabel("MITUL PRAJAPATI - L.J. UNIVERSITY");
		lblNewLabel.setBounds(10, 11, 147, 24);
		contentPanel.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("CREATED USING JAVA");
