...
class Game extends JPanel implements ActionListener
{
    ...
    // this method is used to paint the components on the board like ball,paddles etc.
...
//        Toolkit.getDefaultToolkit().sync();
    ...
    public void gameOver(Graphics g)
    {
        ...
        FontMetrics metr = getFontMetrics(small);//precise information of the font
...
class Frame extends JFrame implements ActionListener,MouseListener
{
    ...
    Frame(int x,int y,int width,int height)
    {
        ...
        Button pause = new Button("RESTART");
        pause.setBounds(555, 3, 70, 30);
        ...
        pause.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Game1Play.e1.dispose();
                Game1Play.e1 = new Frame(0,0,1100,600);
                Game1Play.e1.setBounds(200,150,1100,638);
                Game1Play.e1.setVisible(true);
            }
        });
        cont.add(pause);
